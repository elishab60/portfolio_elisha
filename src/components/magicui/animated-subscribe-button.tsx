...
interface AnimatedSubscribeButtonProps {
    ...
    onClick?: () => void;  // Ajouter une prop onClick
}
...
> = ({
    ...
    const handleButtonClick = () => {
        if (onClick) {
            onClick();  // Appeler la fonction onClick lors du clic sur le bouton
        }
        ...
        <AnimatePresence mode="wait">
            {isSubscribed ? (
                ...
                <motion.button
                    ...
                    onClick={handleButtonClick}  // Utiliser handleButtonClick au lieu de setIsSubscribed
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    exit={{ opacity: 0 }}
                >
